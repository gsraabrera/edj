                        ...
                        <div class="col-md-9">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th></th>
                                    <td>
                                        <a href="{{route('eic.download-file', [$data->id,'cover_letter','t'=>date('YmdHis')])}}" target="_blank">
                                            <button class="btn btn-primary">View Cover Letter</button>
                                        </a>
                                        <a href="{{route('eic.download-file', [$data->id,'signed_author_agreement','t'=>date('YmdHis')])}}" target="_blank">
                                            <button class="btn btn-primary">View Signed authors’ agreement form</button>
                                        </a>
                                        <a href="{{route('eic.download-file', [$data->id,'article','t'=>date('YmdHis')])}}" target="_blank">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="dropdown mt-3">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="#" id="decisionBtn"  data-toggle="modal" data-target="#decisionModal">Make Decision</a> 
                                            <a class="dropdown-item" href="#" id="forwardMEBtn"  data-toggle="modal" data-target="#forwardMEModal">Forward to ME</a>    
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach ($data->reviewers as $value)
                            <tr>
                                ...
                                <td>
                                    @if($value->status === 'Review Submitted')
...
<form action="{{ route('eic.decision') }}" id="decisionForm" method="post" enctype="multipart/form-data">
@csrf
    <div class="modal fade" tabindex="-1" role="dialog" id="decisionModal">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <div class="form-group md-form">
                <label for="exampleInputName1">Decision</label>
                <input type="hidden" name="id" value="{{ $data->id }}">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="decision" id="flexRadioDefault1" value="Accepted" checked>
                    <label class="form-check-label" for="flexRadioDefault1">
                        Accept
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="decision" id="flexRadioDefault1" value="Accepted with revision">
                    <label class="form-check-label" for="flexRadioDefault1">
                        Accept with revision
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="decision" id="flexRadioDefault1" value="Rejected">
                    <label class="form-check-label" for="flexRadioDefault1">
                        Reject
                    </label>
                </div>
            ...
            <div class="form-group md-form">
                <label for="exampleInputName1">Comment (optional)</label>
...
<form action="{{ route('sme.forward-eic') }}" id="forwardEICForm" method="post" >
@csrf
...
<form action="{{ route('sme.forward-me') }}" id="forwardSMEForm" method="post" >
@csrf
    <div class="modal fade" tabindex="-1" role="dialog" id="forwardMEModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Forward to Managing Editor</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <div class="form-group md-form">
                <input type="hidden" name="id" value="{{ $data->id }}">
                Are you sure you want to forward this to Managing Editor?
                <div class="input-feedback"> </div>
            </div>
        </div>
        <div class="modal-footer">
