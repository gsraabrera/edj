            ...
            <div class="card mt-5 px-5">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="form-group row">
                            <label for="current_job_title" class="col-md-4 col-form-label text-md-right">{{ __('Current Job Title') }}</label>

                            <div class="col-md-6">
                                <input id="current_job_title" type="text" class="form-control @error('current_job_title') is-invalid @enderror" name="current_job_title" value="{{ old('current_job_title') }}" required autocomplete="current_job_title" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="department_research_unit" class="col-md-4 col-form-label text-md-right">{{ __('Department/Research Unit') }}</label>

                            <div class="col-md-6">
                                <input id="department_research_unit" type="text" class="form-control @error('department_research_unit') is-invalid @enderror" name="department_research_unit" value="{{ old('department_research_unit') }}" required autocomplete="department_research_unit" autofocus>
