                        ...
                        <div class="col-md-9">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th></th>
                                    <td>
                                        <a href="{{route('sme.download-file', [$data->id,'cover_letter','t'=>date('YmdHis')])}}" target="_blank">
                                            <button class="btn btn-primary">View Cover Letter</button>
                                        </a>
                                        <a href="{{route('sme.download-file', [$data->id,'signed_author_agreement','t'=>date('YmdHis')])}}" target="_blank">
                                            <button class="btn btn-primary">View Signed authors’ agreement form</button>
                                        </a>
                                        <a href="{{route('sme.download-file', [$data->id,'article','t'=>date('YmdHis')])}}" target="_blank">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="dropdown mt-3">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="#" id="recommendBtn"  data-toggle="modal" data-target="#recommendModal">Recommend</a> 
...
<!-- modal -->
<form action="{{ route('sme.update-file') }}" id="updateFile" method="post" enctype="multipart/form-data">
@csrf
...
<form action="{{ route('sme.recommend') }}" id="recommendForm" method="post" enctype="multipart/form-data">
@csrf
    <div class="modal fade" tabindex="-1" role="dialog" id="recommendModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
            <div class="form-group md-form">
                <label for="exampleInputName1">Recommendation</label>
                <input type="hidden" name="id" value="{{ $data->id }}">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="recommendation" id="flexRadioDefault1" value="Accept" checked>
                    <label class="form-check-label" for="flexRadioDefault1">
                        Accept
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="recommendation" id="flexRadioDefault1" value="Reject">
                    <label class="form-check-label" for="flexRadioDefault1">
                        Reject
                    </label>
                </div>
